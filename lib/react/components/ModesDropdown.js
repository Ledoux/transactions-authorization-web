...
var ModesDropdown = function ModesDropdown(_ref) {
  ...
  var search = (0, _transactionsReduxReact.getLocationSearch)(window.location.search);
  return _react2.default.createElement(
    ...
    { className: 'modes-dropdown',
      ...
      onChange: function onChange(event) {
        ...
        var nextSearch = (0, _transactionsReduxReact.getLocationSearchString)(Object.assign(search, { selectedHomeName: homeName }));
